...
namespace UnityEngine.UI.Extensions
{
    public class ScrollSnapBase : MonoBehaviour, IBeginDragHandler, IDragHandler, IScrollSnap
    {
        ...
        [SerializeField]
        [Tooltip("Event Touch")]
        private SelectionPageChangedEvent m_OnTouch = new SelectionPageChangedEvent();
        public SelectionPageChangedEvent OnTouch { get { return m_OnTouch; } set { m_OnTouch = value; } }
        ...
        public void TouchThisWindow()
        {
            if (!_moveStarted) SetTouch();
        }
        /// <summary>
